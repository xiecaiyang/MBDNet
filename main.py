...
parser.add_argument('--train_dir', dest='train_dir',default='/home/xcy/dataset/dataset_denoise/BSD300_trans/hor/', help="Train data dir")
#parser.add_argument('--train_dir', dest='train_dir', default='./data/train', help="Train data dir")
parser.add_argument('--test_dir', dest='test_dir', default='/home/xcy/dataset/dataset_denoise/BSD_gray/', help='Test data dir, support *jpg only')
